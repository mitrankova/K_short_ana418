...
class AlignmentTransformation
{
 ...
 private:
  ...
  //std::string alignmentParamsFile = "/cvmfs/sphenix.sdcc.bnl.gov/calibrations/sphnxpro/cdb/TRACKINGALIGNMENT/8c/7a/8c7a4bd674c9ed3fd85fc5a9e216cf1d_tracking_alignment_parameters_empty.txt";
